...
theme: /
    ...
    state: YouDontUnderstand
        ...
        a: Я не силен в смол-токе, не отвечаю на вопросы и не консультирую. Но я с удовольствием сыграю с вами в "Быки и коровы"!
        buttons:
            "Правила игры" -> /GameRules
            "Сыграем!" -> /*Началась игра*
    ...
    state: YouAreABadHelper
        ...
        q!: * {(ты/тебя) * (непонятливый/тупой/тупишь/глупый/так себе*/никак не/никакой/никакущ*/дурак/дебил*/дибил*) * [$bot/работ*/помощник*/операт*/совет*]} *
        ...
        a: Ну извините! У меня есть функционал: играть в "Быков и коров". Не серчайте на меня. Вот вам кнопки!
        buttons:
            "Правила игры" -> /GameRules
            "Сыграем!" -> /*Началась игра*
